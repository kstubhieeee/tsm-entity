...
export default function TestimonialsSection() {
  ...
  const testimonials = [
    {
      quote:
        "Medira has transformed our hospital operations. Bed management, admissions, and inventory tracking are now seamless. Our efficiency has improved dramatically!",
    ...
    {
      quote:
        "As a patient, Medira makes healthcare so accessible. Booking appointments, accessing my medical records, and getting support is incredibly easy. It's revolutionized my healthcare experience.",
      name: "Anita Patel",
