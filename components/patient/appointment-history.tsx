                ...
                >
                  <div className="flex items-center justify-between">
                    <div className="flex items-center gap-4">
                      <div className="w-12 h-12 bg-[oklch(0.6_0.2_45)] rounded-xl border-2 border-[#151616] flex items-center justify-center">
        ...
        <CardContent>
          {pastAppointments.length === 0 ? (
            ...
            <div className="space-y-4">
              ...
              {pastAppointments.length > 0 && (
                <div className="mt-6 p-4 bg-[oklch(0.6_0.2_45)]/20 rounded-xl border-2 border-[#151616]">
                  <div className="flex items-center justify-between">
                    <div>
