                    ...
                    <Card className="border-2 border-[#151616] shadow-[2px_2px_0px_0px_#151616]">
                        <CardHeader className="pb-3">
                            <div className="flex items-center justify-between">
                                ...
                                <Badge className="bg-[oklch(0.6_0.2_45)] text-white border-[#151616]">
                                ...
                                <div className="space-y-4">
                                    ...
                                    <div className="flex gap-3 justify-center">
                                        ...
                                        <Button
                                            ...
                                            className="bg-[oklch(0.6_0.2_45)] hover:bg-[oklch(0.6_0.2_45)]/80 text-white font-poppins font-bold border-2 border-[#151616] shadow-[2px_2px_0px_0px_#151616] hover:translate-y-0.5 hover:shadow-[1px_1px_0px_0px_#151616] transition-all"
                                        >
                                            {isUploading ? (
                                                <>
                        ...
                        <Card className={`border-2 ${verification.taskCompleted ? 'border-green-500 bg-green-50' : 'border-red-500 bg-red-50'}`}>
                            ...
                            <CardContent className="space-y-4">
                                {verification.taskCompleted && verification.transaction && (
                                    <div className="flex items-center gap-2 p-3 bg-[oklch(0.6_0.2_45)]/20 rounded-xl border border-[#151616]/20">
